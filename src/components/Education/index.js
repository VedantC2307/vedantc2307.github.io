...
const Education = () => {
  return (
    <section className="w-[95%] sm:w-[90%] mx-auto px-4 sm:px-6 py-12 sm:py-16" id="education">
      {/* Section Header */}
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
        {education.map((edu, index) => (
          <div 
            key={index}
            className="tech-card p-6 sm:p-8 min-h-[200px] sm:min-h-[220px] flex flex-col justify-between group"
          >
            <div>
              <div className="flex flex-col sm:flex-row sm:justify-between items-start mb-4 sm:mb-6">
                <div className="flex items-center mb-2 sm:mb-0">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-tech-blue-500 to-cyber-purple-500 rounded-lg flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-white font-tech group-hover:text-tech-blue-600 dark:group-hover:text-tech-blue-400 transition-colors duration-300 leading-tight">
                    {edu.school}
                  </h3>
                </div>
                <span className="text-xs sm:text-sm font-mono text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-metal-gray-700 px-2 sm:px-3 py-1 rounded-full self-start">
                  {edu.duration}
                </span>
              </div>
              
              <p className="text-base sm:text-lg text-tech-blue-600 dark:text-tech-blue-400 mb-3 sm:mb-4 font-medium leading-relaxed">
                {edu.degree}
              </p>
