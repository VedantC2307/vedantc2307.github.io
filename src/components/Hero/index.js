...
const Hero = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800 px-4 md:px-8" id="about">
      <div className="text-center text-white max-w-4xl">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-8">
          {bio.highlights.map((highlight, index) => (
            <span
              key={index}
              className="px-4 py-2 bg-blue-600/20 border border-blue-500/30 rounded-full text-blue-300"
            >
              {highlight}
            </span>
          ))}
